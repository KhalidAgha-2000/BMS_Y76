    ...
    <div className="login--page w-full h-screen m-auto p-4 bg-slate-200 flex items-center">
      ...
      <form
        ...
        className="login-form relative w-1/3 p-1 h-fit m-auto flex flex-col items-center rounded-lg pb-4
                ...
                "
      >
        <h1 className="w-full h-fit p-1 mt-4  text-orange-900  text-center font-bold text-3xl">
          Y76 Shelves
        </h1>
        <em className="w-full h-fit my-4 mb-10 text-orange-900  text-center text-lg">
          {newUser ? "Create new admin account" : "Log In as Administrator"}
        </em>

        <div className="flex flex-col gap-y-6 w-full m-auto items-center">
          {newUser && (
            <div className="w-[90%] relative">
              <label className="absolute -top-3 font-semibold left-2 text-white bg-amber-200 w-fit h-fit text-sm p-[2.1px] rounded-md">
                Username
              </label>
              <input
                className="bg-slate-100 rounded-md w-full h-12 px-2 outline-none focus:outline-amber-700"
          ...
          <button
            disabled={
              email === "" || password === "" || newUser ? username === "" : ""
            }
          ...
          {newUser ? (
            <span className="user--state text-orange-900 cursor-pointer">
      ...
      <div className="flex flex-col fixed bottom-2 gap-y-1">
        <span className="rounded-lg bg-amber-200 px-1 py-2 opacity-50">
